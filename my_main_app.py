...
class MainApp(tk.Tk):
    def __init__(self):
        ...
        self.tasks_gravity= [
            ...
            TaskGravity(
                number=5,
                name="Задание 5: Планета и спутник",
                text1="Спутник на орбите радиуса ",
                text2=" делает полный оборот за период ",
                text3=". Найти массу (кг) тела вокруг которого летает спутник"
            )
        ]
